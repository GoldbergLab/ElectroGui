...
function setupGUI(obj)
    ...
    obj.edit_FileNumber = uicontrol(...
        ...
        'String','0',...
        'Style','edit',...
        'Position',[0.315175097276265 0.9228 0.118677042801556 0.0532],...
    ...
    obj.text_FileNumber = uicontrol(...
        ...
        'String','File',...
        'Style','text',...
        'Position',[0.243190661478599 0.9228 0.0622568093385214 0.0532],...
        'Children',[],...
        'Tag','text1',...
        'FontSize',10);
    ...
    obj.text_TotalFileNumber = uicontrol(...
        ...
        'String','of 0',...
        'Style','text',...
        'Position',[0.449416342412452 0.9228 0.136186770428016 0.0532],...
        'Children',[],...
    ...
    obj.push_PreviousFile = uicontrol(...
        ...
        'FontUnits',get(0,'defaultuicontrolFontUnits'),...
        'String','<<',...
        'Position',[0.0252918287937743 0.9228 0.1 0.0532],...
    ...
    obj.push_NextFile = uicontrol(...
        ...
        'FontUnits',get(0,'defaultuicontrolFontUnits'),...
        'String','>>',...
        'Position',[0.134241245136187 0.9228 0.1 0.0532],...
    ...
    obj.check_ReverseSort = uicontrol(...
        ...
        'String','Reverse',...
        'Style','checkbox',...
        'Position',[0.846303501945526 0.9228 0.14 0.0532],...
    ...
    obj.popup_FileSortOrder = uicontrol(...
        ...
        'Style','popupmenu',...
        'Value',1,...
        'Position',[0.612840466926071 0.9228 0.221789883268483 0.0532],...
        'BackgroundColor',[1 1 1],...
