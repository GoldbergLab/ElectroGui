...
function channel_axes = createChannelAxes(obj, position, innerPosition, tag)
    channel_axes = axes(...
...
function setupGUI(obj)
    ...
    axes_Channel_Positions = {...
        [alignedAxesX 0.21780303030303 alignedAxesW 0.145833333333333],...
        [alignedAxesX 0.0123106060606061 alignedAxesW 0.146780303030303]
    };
    axes_Channel_Inner_Positions = {...
        [alignedAxesX 0.21780303030303 alignedAxesW 0.145833333333333],...
        [alignedAxesX 0.0123106060606061 alignedAxesW 0.146780303030303]
    };

    obj.axes_Channel1 = obj.createChannelAxes( ...
        axes_Channel_Positions{1}, ...
        axes_Channel_Inner_Positions{1}, ...
        'axes_Channel1' ...
        );
    ...
    obj.axes_Channel2 = obj.createChannelAxes( ...
        axes_Channel_Positions{2}, ...
        axes_Channel_Inner_Positions{2}, ...
        'axes_Channel2' ...
        );
    ...
    y1 = 0.377;
    y2 = 0.172;
    channelSourceLabelWidth = 0.039;
    channelSourceLabelHeight = 0.021;
    channelSourceWidth = 0.169;
    channelSourceHeight = 0.028;
    channelFunctionLabelWidth = 0.046;
    channelFunctionLabelHeight = 0.024;
    channelFunctionWidth = 0.123;
    channelFunctionHeight = 0.026;
    eventDetectorLabelWidth = 0.0697190426638917;
    eventDetectorLabelHeight = 0.0208333333333333;
    eventDetectorWidth = 0.107700312174818;
    eventDetectorHeight = 0.0274621212121212;
    clearEventsWidth = 0.05;
    clearEventsHeight = 0.0340909090909091;
    detectWidth = 0.05;
    detectHeight = 0.0340909090909091;
    ...
    obj.text_ChannelSource1 = uicontrol(...
        ...
        'String','Source',...
        'Style','text',...
        'Position',[x1, y1, channelSourceLabelWidth, channelSourceLabelHeight],...
        'Tag','text8');
    ...
    obj.text_ChannelSource2 = uicontrol(...
        ...
        'String','Source',...
        'Style','text',...
        'Position',[x1, y2, channelSourceLabelWidth, channelSourceLabelHeight],...
        'Tag','text9');
    ...
    obj.popup_Channel1 = uicontrol(...
        ...
        'Style','popupmenu',...
        'Value',1,...
        'Position',[x2, y1, channelSourceWidth, channelSourceHeight],...
        'BackgroundColor',[1 1 1],...
    ...
    obj.popup_Channel2 = uicontrol(...
        ...
        'Style','popupmenu',...
        'Value',1,...
        'Position',[x2, y2, channelSourceWidth, channelSourceHeight],...
        'BackgroundColor',[1 1 1],...
    ...
    obj.text_ChannelFunction1 = uicontrol(...
        ...
        'String','Function',...
        'Style','text',...
        'Position',[x3, y1, channelFunctionLabelWidth, channelFunctionLabelHeight],...
        'Tag','text10');
    ...
    obj.text_ChannelFunction2 = uicontrol(...
        ...
        'String','Function',...
        'Style','text',...
        'Position',[x3, y2, channelFunctionLabelWidth, channelFunctionLabelHeight],...
        'Tag','text15');
    ...
    obj.popup_Function1 = uicontrol(...
        ...
        'Style','popupmenu',...
        'Value',1,...
        'Position',[x4, y1, channelFunctionWidth, channelFunctionHeight],...
        'BackgroundColor',[1 1 1],...
    ...
    obj.popup_Function2 = uicontrol(...
        ...
        'Style','popupmenu',...
        'Value',1,...
        'Position',[x4, y2, channelFunctionWidth, channelFunctionHeight],...
        'BackgroundColor',[1 1 1],...
    ...
    obj.text_EventDetector1 = uicontrol(...
        ...
        'Style','text',...
        'Position',[x5, y1, eventDetectorLabelWidth, eventDetectorLabelHeight],...
        'Tag','text12');
    ...
    obj.text_EventDetector2 = uicontrol(...
        ...
        'String','Event detector',...
        'Style','text',...
        'Position',[x5, y2, eventDetectorLabelWidth, eventDetectorLabelHeight],...
        'Tag','text14');
    ...
    obj.popup_EventDetector1 = uicontrol(...
        ...
        'Style','popupmenu',...
        'Value',1,...
        'Position',[x6, y1, eventDetectorWidth, eventDetectorHeight],...
        'BackgroundColor',[1 1 1],...
    ...
    obj.popup_EventDetector2 = uicontrol(...
        ...
        'Style','popupmenu',...
        'Value',1,...
        'Position',[x6, y2, eventDetectorWidth, eventDetectorHeight],...
        'BackgroundColor',[1 1 1],...
    ...
    obj.push_ClearEvents1 = uicontrol(...
        ...
        'Units','normalized',...
        'String','Clear',...
        'Position',[x7, y1, clearEventsWidth, clearEventsHeight],...
    ...
    obj.push_ClearEvents2 = uicontrol(...
        ...
        'Units','normalized',...
        'String','Clear',...
        'Position',[x7, y2, clearEventsWidth, clearEventsHeight],...
    ...
    obj.push_Detect1 = uicontrol(...
        ...
        'Units','normalized',...
        'String','Detect',...
        'Position',[x8, y1, detectWidth, detectHeight],...
    ...
    obj.push_Detect2 = uicontrol(...
        ...
        'Units','normalized',...
        'String','Detect',...
        'Position',[x8, y2, detectWidth, detectHeight],...
