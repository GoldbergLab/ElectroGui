...
handles.FileString = '*chan##.txt'; % File search string; use ## to indicate double digit channel number when number of channels are greater than 10
handles.DefaultFileLoader = 'HC_ad'; % Default file loader. Choose from egl_* files.
