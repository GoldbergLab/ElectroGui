function fig = VP_RC_plot_motifonly5ms(dbase, varargin)
...
eventOnsetsHit = dbase.trigInfohitbin05.events;
eventOnsetsEscape = dbase.trigInfocatchbin05.events;
% eventOnsetsHitpreCC = dbase.trigInfohitbin05preCC.events;
% eventOnsetsEscapepreCC = dbase.trigInfocatchbin05preCC.events;
% eventOnsetsHitpostCC = dbase.trigInfohitbin05postCC.events;
% eventOnsetsEscapepostCC = dbase.trigInfocatchbin05postCC.events;
...
edges = dbase.trigInfohitbin05.edges;
rdhit = dbase.trigInfohitbin05.rd;
% rdhitpreCC = dbase.trigInfohitbin05preCC.rd;
% rdhitpostCC = dbase.trigInfohitbin05postCC.rd;
rdescape = dbase.trigInfocatchbin05.rd;
% rdescapepreCC = dbase.trigInfocatchbin05preCC.rd;
% rdescapepostCC = dbase.trigInfocatchbin05postCC.rd;
...
rdhitsmooth = dbase.trigInfohitbin05.rds;
rdescapesmooth = dbase.trigInfocatchbin05.rds;
...
dataStart = dbase.trigInfohitbin05.edges(1);
dataStop = dbase.trigInfohitbin05.edges(end);
pmin = dbase.trigInfohitbin05.pval.minrates;
pmin_stats(count) = pmin;
mintime = dbase.trigInfohitbin05.corrtime.mins;
pmax = dbase.trigInfocatchbin05.pval.maxrates;
pmax_stats(count) = pmax;
maxtime = dbase.trigInfocatchbin05.corrtime.maxs;
hitmin = min(rdhitsmooth);
escapemax = max(rdescapesmooth);
yrange = escapemax-hitmin;
trigStarts = dbase.trigInfohitbin05.trigStarts;
