% 4ms win (inherited from triginfo motif), smooth 5
...
% get motif
trigInfo = dbase.trigInfomotifCaseI.warped{1};
%trigInfo = [dbase.trigInfomotifCaseI.warped{1}, dbase.trigInfomotifCaseI.warped{2}, dbase.trigInfomotifCaseI.warped{3}];
