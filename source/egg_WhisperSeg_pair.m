function [segmentTimes, segmentTitles] = egg_WhisperSeg_pair(data, amp, fs, thresh, params)
...
function ID = identify_singerID(amp, fs, thresh, params)
% helper to captalize based on singer ID