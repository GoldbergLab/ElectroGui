function dbase = vgm_dprime_move(dbase, N)
...
eventOnsetsHit = dbase.trigInfomovehitbin25.events;
eventOnsetsEscape = dbase.trigInfomovecatchbin25.events;
eventOnsetsAll = [eventOnsetsHit eventOnsetsEscape];
dataStart = dbase.trigInfomovehitbin25.edges(1);
dataStop = dbase.trigInfomovehitbin25.edges(end);
