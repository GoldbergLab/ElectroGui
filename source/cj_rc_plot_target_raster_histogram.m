...
edges = dbase.trigInfohitbin10.edges;
rdhit = dbase.trigInfohitbin10.rd;
...
rdhitsmooth = dbase.trigInfohitbin10.rds;
rdescapesmooth = dbase.trigInfocatchbin10.rds;
...
dataStart = dbase.trigInfohitbin10.edges(1);
dataStop = dbase.trigInfohitbin10.edges(end);
pmin = dbase.trigInfohitbin10.pval.minrates;
pmin_stats(count) = pmin;
mintime = dbase.trigInfohitbin10.corrtime.mins;
...
trigStarts = dbase.trigInfohitbin10.trigStarts;
...
%subplot.
%s2 = subplot('Position', [0.13 0.35 0.7750 0.55]);  %RC original
