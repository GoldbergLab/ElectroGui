function handles = defaults_ad943(handles)
% Default settings

% GENERAL SETTINGS
handles.TooLong = 4000000; % Number of points for a file to be considered too long for loading automatically
handles.FileString = '*chan#.txt'; % File search string; use # to indicate channel number
handles.DefaultFileLoader = 'AA_daq'; % Default file loader. Choose from egl_* files.
handles.DefaultChannelNumber = 17; % Default number of channels
