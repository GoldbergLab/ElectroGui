function [filestarttimes fileendtimes syllstarttimes syllendtimes syll_durs preintrvl postintrvl allintrvls syllnames] = vgm_dbaseGetSylls(dbase)
...
for i=1:length(dbase.Times2)
    ...
    % skip all BOS playback files for the purpose of finding sylls.
    if BOS~=0 & dbase.Properties.Values{i}{BOS}
        continue
    end
