...
target_dir = 'X:\Budgie\0010_0572\dbases\caleb_dbases\Sorted_newsegs\pyfiles\';
...
%         downsamplefac = round(length(movecom)/length(kt));
...
%         mi_amp_spks = mi_cont_cont(amp,ifr);
%         mi_mov_spks = mi_cont_cont(movecom,ifr);
...
%         H.Position= [154         197        1609         779];
    ...
    clear gaussian_kernel dbase
    % SAVE to .mat
    save([target_dir  'spkdatforpy_' names{i}])
