function handles = defaults_Caleb(handles)
% Default settings
...
handles.AmplitudeLims = [0 85]; % Y-axis limits for the amplitude plot
...
handles.DefaultSegmenter = 'DA_segmenter_old'; % Algorithm to use for segmentation. Choose from egg_* files.
